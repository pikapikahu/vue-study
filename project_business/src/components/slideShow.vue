...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  ...
  .slide-show h2{position:absolute;width 100%;color #fff;background #000;opacity .5;bottom 0;height:30px;text-align left;padding-left 15px }
  .slide-img{width:100%}
  ...
  .slide-pages li .on{text-decoration: underline;color #fff}
</style>
