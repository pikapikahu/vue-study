...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .selection-show .arrow{display:inline-block;border-left 4px solid transparent;border-right 4px solid transparent;border-top 5px solid #e3e3e3;width 0;height 0;margin-top -1px;margin-left 6px;margin-right -14px;vertical-align middle}
